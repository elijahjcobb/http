...
export class HEndpointBuilder {
	...
	private _types: OObjectTypeDefinition | undefined;
	private _upload: HUploadManagerConstructorType | undefined;
	...
	public types(type: OObjectTypeDefinition): HEndpointBuilder {
	...
	public static get(endpoint: string): HEndpointBuilder { return new HEndpointBuilder(endpoint, HMethod.GET); }
	public static post(endpoint: string): HEndpointBuilder { return new HEndpointBuilder(endpoint, HMethod.POST); }
	public static put(endpoint: string): HEndpointBuilder { return new HEndpointBuilder(endpoint, HMethod.PUT); }
	public static delete(endpoint: string): HEndpointBuilder { return new HEndpointBuilder(endpoint, HMethod.DELETE); }
